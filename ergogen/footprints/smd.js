module.exports = {
    ...
    (footprint ComboDiode (layer F.Cu) (tedit 5B24D78E)
        ...
        (pad 1 thru_hole circle (at -1.65 0 ${p.rot}) (size 0.6 0.6) (drill 0.3) (layers "*.Cu") (zone_connect 2) ${p.to})
        (pad 1 thru_hole circle (at 1.65 0 ${p.rot}) (size 0.6 0.6) (drill 0.3) (layers "*.Cu") (zone_connect 2) ${p.from})
